...
export default function Sidebar() {
    ...
    return (
        <div>
            <div className={`${isHide ? 'hidden' : 'block'} mt-4`} onClick={() => setIsHide(!isHide)}>show</div>

            <div className={`${isHide ? 'block' : 'hidden'} relative h-screen w-64 shadow-md p-4 border-r border-gray-200 transition-all duration-300`}>
